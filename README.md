...
Now, the table from [[Hastie, *et al*, 2009, Table 10.1, p. 351]](https://web.stanford.edu/~hastie/Papers/ESLII.pdf) in the [Modeling](https://github.com/hamlett-neil-ur/housing_price_model#modeling) section above leads us to expect good results from Tree-based methods.  It also leads to expect strong from the ANN and the kNN models, also.  Results from the latter two are less-strong.  These disparities merit further subsequent investigation.
